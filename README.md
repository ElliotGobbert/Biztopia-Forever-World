...
| Name | Known Incompatibilities | Description | Client/Server Side |
| :--- | :---: | :---: | :---: |
| [3D Skin Layers](https://www.curseforge.com/minecraft/mc-mods/skin-layers-3d) | Unknown | Renders the second layer of a player's skin in 3D, adding visible depth. | Client |
| [Accelerated Decay](https://www.curseforge.com/minecraft/mc-mods/accelerated-decay) | Unknown | Makes leaves decay much faster after a tree is cut down. | Server |
| [Almost Unified](https://www.curseforge.com/minecraft/mc-mods/almost-unified) | Unknown | Unifies resources from different mods, converting them to a single preferred type (e.g., all Copper Ingots). | Both |
| [Amecs](https://modrinth.com/mod/amecs) | Other core keybinding mods | Allows for more complex key combinations and fixes issues with non-US keyboard layouts. | Client |
| [AppleSkin](https://www.curseforge.com/minecraft/mc-mods/appleskin) | Unknown | Adds food value information to tooltips and visualizes saturation/hunger restored on the HUD. | Client |
| [Better Advancements](https://www.curseforge.com/minecraft/mc-mods/better-advancements) | Unknown | Improves the UI and UX of the advancements screen, making it more organized and easier to navigate. | Client |
